...
const MODULES = [
  ...
  { id: 'exercise-svg-pages', pages: ['biblioteca-exercicios.html', 'aluno.html', 'visualizar-aluno.html'], source: './exercise-svg-pages.js?v=20260801-pages2', errorMessage: 'Ilustrações dos exercícios indisponíveis:' }
];
